  ...
  <section class="main-container">
    <el-form :inline="true" :model="articleForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item label="作者账号：">
        <el-input v-model="articleForm.account" placeholder="请输入作者账号" clearable></el-input>
      </el-form-item>
      <el-form-item label="网络平台：">
        <el-input v-model="articleForm.platform" placeholder="请输入网络平台" clearable></el-input>
      </el-form-item>
      <el-form-item label="公司名称：">
        <el-input v-model="articleForm.company" placeholder="请输入公司名称" clearable></el-input>
      </el-form-item>
      <el-form-item label="删除时间：">
        <el-date-picker
          v-model="articleForm.delDate"
          type="daterange"
          align="right"
          unlink-panels
          range-separator="至"
      ...
      <el-form-item label="状态：">
        <el-select v-model="articleForm.region" placeholder="请选择发布状态">
      ...
      <el-table-column label="操作" fixed="right" width="200">
        <template slot-scope="scope">
          <el-button type="text" :disabled="!scope.row.status">
            {{scope.row.status ? '认证' : '已认证'}}
          </el-button>
          <el-button type="text" :disabled="scope.row.status">
            {{scope.row.status ? '发函' : '二次发函'}}
          </el-button>
